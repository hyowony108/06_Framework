...
public class MyPageController {
	 ...
	 * @param SessionStatus	: 세션 완료 용도의 객체 -> @SessionAttributes 로 등록한 세션을 완료
	 * @return
	 */
	...
	public String fileUpload12(@RequestParam("uploadFile") MultipartFile uploadFile,
							   @SessionAttribute("loginMember") Member loginMember,
							   RedirectAttributes ra) throws Exception {
	...
	public String fileUpload3(@RequestParam("aaa") List<MultipartFile> aaaList,
		...
		// aaa 파일 미제출 시
		// -> 0번, 1번 인텍스가 존재하는 List가 있음
		// -> 0,1번 인덱스에는 MultipartFile 객체가 존재하나, 둘 다 비어있는 객체인 상태.
		// -> 0, 1번 인덱스가 존재하는 이유는 html에서 제출된 파라미터 중 name 값이 aaa
	...
	public String profile( @RequestParam("profileImg") MultipartFile profileImg, 
		...
		// 업로드된 파일 정보를 DB 에 INSERT 후 결과 행의 갯수 반환 받을 예정
