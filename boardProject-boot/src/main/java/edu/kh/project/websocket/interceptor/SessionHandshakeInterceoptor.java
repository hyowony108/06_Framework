...
/** SessionHandshakeInterceoptor 클래스
 * 
 * webSocketHandler 가 동작하기 전/후에
 * 연결된 크라이언트 세션을 가로채는 동작을 작성할 클래스
 */
@Component // Bean 등록
public class SessionHandshakeInterceoptor implements HandshakeInterceptor{
	...
	public boolean beforeHandshake(ServerHttpRequest request,
		...
		// request 가 참조하는 객체가 
		// ServletHttpRequest -> ServletHttpRequest => HttpServiceRequest
