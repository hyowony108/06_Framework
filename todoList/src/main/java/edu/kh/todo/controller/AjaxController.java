 ...
 * 
 * -> 해당 어노테이션이 붙은 컨트롤러의 메서드는 return에 작성된 값이 forward/redirect 로 인식
 * 
 * 
 * @RequestBody
...
public class AjaxController {
	...
	// @Autowired
	// -> 등록된 Bean 중 같은 타입 또는 상속관걔인 Bean을 찾아
	// 해당 필드에 의존성 주입
