...
@Configuration // 서버가 켜질 때 해당 클래스 내 모든 내용 실
public class FilterConfig {

	@Bean // 반환된 객체를 Bean으로 등록 : LoginFilter 타입을 제한한 객체를 Bean으로 등록함
	public FilterRegistrationBean<LoginFilter> loginFeilter() {
